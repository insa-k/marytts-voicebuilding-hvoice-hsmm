...
def xml = builder.bind {
	'marytts-install'(xmlns: 'http://mary.dfki.de/installer') {
		voice(gender: "female", locale: "en-US", name: project.properties.voiceName, type: "marytts.htsengine.HMMVoice", version: project.version) {
			...
			depends(language: "en", version: project.version)
		}
	}
}
